...
const translations = {
  en: {
    ...
    // Reports page
    "reports.title": "SLA Reports",
    "reports.subtitle": "SLA performance reports by user",
    "reports.filters": "Report Filters",
    "reports.allUsers": "All Users",
    "reports.selectUser": "Select User",
    "reports.dateRange": "Date Range",
    "reports.totalRecords": "Total Records",
    "reports.completedRecords": "Completed",
    "reports.violatedRecords": "SLA Violations",
    "reports.pendingRecords": "In Progress",
    "reports.successRate": "Success Rate",
    "reports.avgCompletionTime": "Avg Time",
    ...
    "records.approvedAt": "Approved At",
    "records.nextDueAt": "Next Due At",
  ...
  vi: {
    ...
    "slaLogs.workflowName": "Tên quy trình",
    ...
    "slaLogs.id": "ID",
    "slaLogs.user": "Người dùng",
    "slaLogs.workflow": "Quy trình",
    "slaLogs.activity": "Hoạt động",
    "slaLogs.type": "Loại",
    "slaLogs.violation": "Vi phạm",
    "slaLogs.status": "Trạng thái",
    "slaLogs.time": "Thời gian",
    ...
    "dashboard.viewAllRecords": "Xem tất cả bản ghi",
    ...
    // Reports page
    "reports.title": "Báo cáo SLA",
    "reports.subtitle": "Báo cáo hiệu suất SLA theo người dùng",
    "reports.filters": "Bộ lọc báo cáo",
    "reports.allUsers": "Tất cả người dùng",
    "reports.selectUser": "Chọn người dùng",
    "reports.dateRange": "Khoảng thời gian",
    "reports.totalRecords": "Tổng số bản ghi",
    "reports.completedRecords": "Đã hoàn thành",
    "reports.violatedRecords": "Vi phạm SLA",
    "reports.pendingRecords": "Đang xử lý",
    "reports.successRate": "Tỷ lệ thành công",
    "reports.avgCompletionTime": "Thời gian TB",
    "reports.exportExcel": "Xuất Excel",
    "reports.exportPdf": "Xuất PDF",
    "reports.noData": "Không có dữ liệu báo cáo",
    "reports.loading": "Đang tải dữ liệu...",
    ...
    "dashboard.allRecords": "Tất cả bản ghi",
    "dashboard.viewAllRecords": "Xem tất cả bản ghi",
    "dashboard.noRecordsFound": "Không tìm thấy bản ghi nào cho chỉ số này",
    ...
    "workflows.manageSystems": "Quản lý Hệ thống",
    "workflows.connectedSystems": "Hệ thống đã kết nối",
    "workflows.systemStatistics": "Thống kê theo Hệ thống",
    "records.title": "Bản ghi",
    "records.subtitle":
      " ",
    ...
    "records.approvedAt": "Ngày phê duyệt",
    "records.nextDueAt": "Ngày đến hạn tiếp theo",
    ...
    "systems.title": "Hệ thống",
    "systems.subtitle": "Quản lý các hệ thống kết nối bên ngoài",
    "systems.addSystem": "Thêm Hệ thống",
    "systems.totalSystems": "Tổng Hệ thống",
    "systems.configuredSystems": "Hệ thống đã cấu hình",
    "systems.activeSystems": "Hệ thống đang hoạt động",
    "systems.systemList": "Danh sách Hệ thống",
    "systems.addNewSystem": "Thêm Hệ thống Mới",
    "systems.systemAdded": "Hệ thống đã được thêm!",
    "systems.systemNotFound": "Hệ thống không tìm thấy",
    "systems.systemConnected": "Hệ thống đã kết nối thành công",
    "systems.systemDeleted": "Hệ thống đã được xóa thành công",
    "systems.systemName": "Tên hệ thống",
    "systems.systemIcon": "Icon hệ thống",
    "systems.systemColor": "Màu hệ thống",
    "systems.connectionUrl": "URL kết nối",
    "systems.apiKey": "API Key",
    "systems.status": "Trạng thái",
    "systems.connected": "Đã kết nối",
    "systems.disconnected": "Chưa kết nối",
    "systems.workflows": "Quy trình",
    "systems.violations": "Vi phạm",
    "systems.lastSync": "Lần sync cuối",
    "systems.neverSynced": "Chưa sync",
